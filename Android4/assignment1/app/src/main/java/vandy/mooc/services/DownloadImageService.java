...
public class DownloadImageService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        msgIntent.setData(url);
        msgIntent.putExtra("requestCode", requestCode);
        msgIntent.putExtra(MESSENGER, new Messenger(downloadHandler));
        msgIntent.putExtra(DIRECTORY_PATHNAME, directoryPathname);
        return msgIntent;
    }
